...
constexpr const RideTypeDescriptor HydraulicLaunchedRollerCoasterRTD =
{
    ...
    SET_FIELD(getirdetypedescriptor(, {3,{{RIDE_TYPE_HYDRAULIC_LAUNCHED_ROLLER_COASTER_ALT_2,SPR_RIDE_CONSTRUCTION_BI_RAIL_TRACK},{RIDE_TYPE_HYDRAULIC_LAUNCHED_ROLLER_COASTER_ALT_1,SPR_RIDE_CONSTRUCTION_TRI_RAIL_TRACK},{RIDE_TYPE_HYDRAULIC_LAUNCHED_ROLLER_COASTER,SPR_RIDE_CONSTRUCTION_QUAD_RAIL_TRACK}}}),
};
