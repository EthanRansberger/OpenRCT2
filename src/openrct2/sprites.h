...
enum
{
    ...
    SPR_G2_PIPELINE_BEGIN = SPR_G2_ALPINE_END,
    SPR_G2_PIPELINE_TRACK_FLAT = SPR_G2_PIPELINE_BEGIN,
    SPR_G2_PIPELINE_TRACK_BRAKE = SPR_G2_PIPELINE_BEGIN + 4,
    SPR_G2_PIPELINE_TRACK_BLOCK_BRAKE = SPR_G2_PIPELINE_BEGIN + 8,
    SPR_G2_PIPELINE_TRACK_GENTLE = SPR_G2_PIPELINE_BEGIN + 12,
    SPR_G2_PIPELINE_TRACK_STEEP = SPR_G2_PIPELINE_BEGIN + 36,
    SPR_G2_PIPELINE_TRACK_SMALL_CURVE = SPR_G2_PIPELINE_BEGIN + 60,
    SPR_G2_PIPELINE_TRACK_MEDIUM_CURVE = SPR_G2_PIPELINE_BEGIN + 84,
    SPR_G2_PIPELINE_TRACK_LARGE_CURVE = SPR_G2_PIPELINE_BEGIN + 124,

    SPR_G2_PIPELINE_TRACK_FLAT_DIAGONAL = SPR_G2_PIPELINE_BEGIN + 188,
    SPR_G2_PIPELINE_TRACK_GENTLE_DIAGONAL = SPR_G2_PIPELINE_BEGIN + 194,
    SPR_G2_PIPELINE_TRACK_STEEP_DIAGONAL = SPR_G2_PIPELINE_BEGIN + 212,

    SPR_G2_PIPELINE_TRACK_BANK_TRANSITION = SPR_G2_PIPELINE_BEGIN + 230,
    SPR_G2_PIPELINE_TRACK_BANK_TRANSITION_DIAGONAL = SPR_G2_PIPELINE_BEGIN + 286,
    SPR_G2_PIPELINE_TRACK_SMALL_CURVE_BANKED = SPR_G2_PIPELINE_BEGIN + 342,
    SPR_G2_PIPELINE_TRACK_MEDIUM_CURVE_BANKED = SPR_G2_PIPELINE_BEGIN + 366,
    SPR_G2_PIPELINE_TRACK_LARGE_CURVE_BANKED = SPR_G2_PIPELINE_BEGIN + 406,
    SPR_G2_PIPELINE_TRACK_INLINE_TWIST = SPR_G2_PIPELINE_BEGIN + 470,
    SPR_G2_PIPELINE_TRACK_HALF_LOOP = SPR_G2_PIPELINE_BEGIN + 518,
/*
    SPR_G2_PIPELINE_TRACK_GENTLE_SMALL_CURVE = SPR_G2_PIPELINE_BEGIN + 282,
    SPR_G2_PIPELINE_TRACK_GENTLE_MEDIUM_CURVE = SPR_G2_PIPELINE_BEGIN + 298,
    SPR_G2_PIPELINE_TRACK_STEEP_SMALL_CURVE = SPR_G2_PIPELINE_BEGIN + 338,
    ...
    SPR_G2_PIPELINE_TRACK_SMALL_HELIX = SPR_G2_PIPELINE_BEGIN + 502,
    SPR_G2_PIPELINE_TRACK_LARGE_HELIX = SPR_G2_PIPELINE_BEGIN + 530,
    SPR_G2_PIPELINE_TRACK_TURN_BANK_TRANSITION = SPR_G2_PIPELINE_BEGIN + 706,
*/
    SPR_G2_PIPELINE_LIFT_BEGIN = SPR_G2_PIPELINE_BEGIN + 550,
    SPR_G2_PIPELINE_LIFT_TRACK_FLAT = SPR_G2_PIPELINE_LIFT_BEGIN,
    SPR_G2_PIPELINE_LIFT_TRACK_GENTLE = SPR_G2_PIPELINE_LIFT_BEGIN + 8,
    SPR_G2_PIPELINE_LIFT_TRACK_FLAT_DIAGONAL = SPR_G2_PIPELINE_BEGIN + 32,
    SPR_G2_PIPELINE_LIFT_TRACK_GENTLE_DIAGONAL = SPR_G2_PIPELINE_BEGIN + 38,
    SPR_G2_PIPELINE_END = SPR_G2_PIPELINE_LIFT_BEGIN + 56,
